    ...
    */
    if ( !class_exists('CC_Utility') ) {
		class CC_Utility {
	        ...
	        var $login;
	        var $password;
	        var $apikey = '0f04f434-ccc2-4c8c-82b7-f535b509ca20'; // API Key for your account.
	        ...
	        public function __construct() {
				$this->login = get_option(Group_Buying_ConstantContact::LOGIN); //Username for your account
		        $this->password = get_option(Group_Buying_ConstantContact::PASSWORD); //Password for your account
	        ...
	        public function getLists($path = '') {
	            ...
	            foreach ($parsedReturn->link as $item) {
	                ...
	                if ((string) $tmp->rel == 'next') {
	                    ...
	                    $nextUrl = str_replace('%40', '@', $nextUrl);
