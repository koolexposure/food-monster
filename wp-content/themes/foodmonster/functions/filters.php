...
/* removing for now need to rethink the url structue CJH
add_filter('gbs_register_post_type_args-gb_merchant', 'gb_merchant_new_rewrite', 9999, 1);
function gb_merchant_new_rewrite($args)
{
    $args['rewrite'] = array(
                'slug' => 'merchants',
                'with_front' => FALSE,
